...
export default function Page() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-500 to-yellow-300 flex flex-col p-10 sm:p-32">
      ...
      <div className="font-bold text-l sm:text-2xl mb-4">Éditeur du site</div>
      ...
      <div className="font-bold text-l sm:text-2xl mb-4">Directeur de la publication</div>
      <p className="pb-8 sm:pb-16 px-0 sm:px-16">{`M. Raphaël Metrop, Président de Sowhat S.A.S. Contact : contact@sowhat-app.com`}</p>

      <div className="font-bold text-l sm:text-2xl mb-4">Hébergeur du site</div>
      <p className="pb-8 sm:pb-16 px-0 sm:px-16">{`Le site est hébergé par la société Vercel (www.vercel.com).`}</p>

      <div className="font-bold text-l sm:text-2xl mb-4">Propriété intellectuelle</div>
      ...
      <div className="font-bold text-l sm:text-2xl mb-4">Responsabilité</div>
      ...
      <div className="font-bold text-l sm:text-2xl mb-4">Liens hypertextes</div>
      ...
      <div className="font-bold text-l sm:text-2xl mb-4">Droit applicable et Juridiction</div>
      <p className="pb-8 sm:pb-16 px-0 sm:px-16">{`Les présentes mentions légales sont régies par le droit français.`}</p>

      <div className="font-bold text-l sm:text-2xl mb-4">Modification des mentions légales</div>
