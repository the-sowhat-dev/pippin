        ...
        <div className="flex flex-col items-center text-center space-y-6">
          {isRedirecting ? (
            <>
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Redirection vers l&apos;application dans {countdown} seconde
                  {countdown !== 1 ? "s" : ""}...
                </p>
              </div>
            ...
            <>
              ...
              <div className="space-y-2">
                <h1 className="text-2xl font-bold text-foreground">
                  Application pas encore installée ?
                </h1>
                <p className="text-muted-foreground">
                  Si l&apos;application n&apos;a pas ouvert automatiquement, vous pouvez la
                  télécharger depuis le {deviceType === "ios" ? "App Store" : "Play Store"}
                </p>
              </div>
