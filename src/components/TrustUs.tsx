...
export default function TrustUs() {
  return (
    <div className="bg-gradient-to-b from-[#203649] to-[#405e79] p-4 md:p-8 py-8">
      <div className="flex flex-col lg:flex-row max-w-4xl gap-8 mx-auto justify-between items-center">
        ...
        <div className="flex gap-6 flex-col sm:flex-row">
          <div
            className="w-[200px] sm:w-[275px] transition-all duration-300 hover:scale-105 items-center flex justify-center"
            title="Yomoni"
          >
