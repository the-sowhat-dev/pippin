...
export const FAQ_EPARGNE_INVESTISSEMENT = [
  ...
  },
  {
    ...
    answer: (
      <>
        <p>
          Les droits de succession seront donc de 20 % maximum pour chacun des enfants. De plus, ils bénéficieront chacun d'un abattement de 100 000 €. Le notaire calcule les droits de succession sur la base de 100 000 € pour chaque enfant. Au-delà de l'abattement, il faudra payer selon un barème fiscal.
        </p>
      </>
    ),
